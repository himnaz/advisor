...
ALTER TABLE pre_prod_20_gold.gold.fact_staff ADD CONSTRAINT ss2_fact_staff_dim_staff FOREIGN KEY (staff_sk) REFERENCES pre_prod_20_gold.gold.dim_staff(esm_sk);

ALTER TABLE pre_prod_20_gold.gold.fact_staff ADD CONSTRAINT ss3_fact_staff_dim_staff FOREIGN KEY (staff_sk) REFERENCES pre_prod_20_gold.gold.dim_staff(asm_sk);

ALTER TABLE pre_prod_20_gold.gold.fact_staff ADD CONSTRAINT ss4_fact_staff_dim_staff FOREIGN KEY (staff_sk,staff_sk) REFERENCES pre_prod_20_gold.gold.dim_staff(supervisor_sk,introducer_sk);
